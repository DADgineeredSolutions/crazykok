...
const classifications = {
  ...
  '0022': ['domain', ['application', 'operation', 'opportunity'], ['domain language', 'event terminology', 'trading terminology']],
  '0023': ['domain', ['operation', 'opportunity'], ['committed work', 'discovery record']],
