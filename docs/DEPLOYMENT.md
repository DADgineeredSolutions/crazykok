...
Open `https://crazykok.local` (or `https://app.crazykok.local`). API health is
...
```text
127.0.0.1 crazykok.local app.crazykok.local api.crazykok.local
::1       crazykok.local app.crazykok.local api.crazykok.local
```
